<div class="d-flex flex-column bg-dark text-white vh-100 p-3" style="width: 250px;">
    ...
    <a href="index.asp" class="text-white text-decoration-none p-2 rounded d-block mb-1">Produtos</a>
    <a href="usuarios.asp" class="text-white text-decoration-none p-2 rounded d-block mb-1">Usuários</a>
    <a href="atualizar.asp" class="text-white text-decoration-none p-2 rounded d-block mb-1">Cadastro/Atualizar</a>
    ...
    <a href="logout.asp" class="btn btn-danger mt-auto">Sair</a>
</div>
